...
import { ArrowRight, Loader2, LogIn, UserPlus, CheckCircle, Shuffle, Search, Repeat, GraduationCap } from 'lucide-react';
          ...
          {stageHeights.map((heightClass, index) => {
            ...
            return (
              <div key={`stage-step-${index}`} className="flex-1 flex flex-col items-center justify-end">
                ...
                <div className={cn("w-full relative flex flex-col items-center justify-start pt-2 px-2 text-center", heightClass, bgColorClass)}>
