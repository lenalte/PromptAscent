...
import { getGeneratedLessonById, type Lesson, type LessonStage, type StageItemStatus, type LessonItem, type StageStatusValue, getUserProgress } from '@/data/lessons';
